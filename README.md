...
coin_ Вы можете заменить на что-то другое (resource_), тогда плагин будет думать, что наградой являются ресурсы. Измените reward.coins на reward.(Материал ресурса, пример: reward.EMERALD), и укажите количество ресурсов, что хотите получить в награду. *Сначала пишется награда, а потом её название* Аналогичная система используется в других типах:
